...
/**
 * 数据类型转换工具，目前没有�?�虑char（Character）类型�??
 *                       
 * @Filename: ConvertUtil.java
 * @Version: 1.0
 * @Author: 蜂虎 - 刘雷
 * @Email: fenghu@mtrong.com
 *
 */
public final class ConvertUtil {
     ...
     * <p>转换不成功时返回defaultValue并记录info或�?�warn日志，不会抛出任何异常�??
     * <p>
     * 1) 字符串的"true"�?"false"值（忽略大小写）会转化为boolean类型的true、false值；
     * <br /> 2) 字符串的"1"�?"0"值会转化为boolean类型的true、fasle值；
     * <br /> 3) value为null或�?�空字符串，会返回defaultValue�?
     * <br /> 4) 除以上情况外，均返回true值；
     * @param value 要转换成boolean值的字符串�??
     * @param defaultValue 转换不成功时的默认�?�（可以为null，这种情况下转换不成功时将返回null值）
     * @return 
     */
     ...
     * <p>转换不成功时返回defaultValue并记录info或�?�warn日志，不会抛出任何异常�??
     * <p>value等于null或�?�为空字符串，或者在转换过程中发生异常，均返回defaultValue，否则返回转换后的{@link Integer}值�??
     ...
     * <br /> 3) value为{@link String}类型时，参�?�{@link #toInt(String, Integer)}�?
     ...
     * <p>转换不成功时返回defaultValue并记录info或�?�warn日志，不会抛出任何异常�??
     * <p>value等于null或�?�为空字符串，或者在转换过程中发生异常，均返回defaultValue，否则返回转换后的{@link Long}值�??
     ...
     * <br /> 3) value为{@link String}类型时，参�?�{@link #toLong(String, Long)}�?
     ...
     * <p>转换不成功时返回defaultValue并记录info或�?�warn日志，不会抛出任何异常�??
     * <p>value等于null或�?�为空字符串，或者在转换过程中发生异常，均返回defaultValue，否则返回转换后的{@link Float}值�??
     ...
     * <br /> 3) value为{@link String}类型时，参�?�{@link #toFloat(String, Float)}�?
     ...
     * <p>转换不成功时返回defaultValue并记录info或�?�warn日志，不会抛出任何异常�??
     * <p>value等于null或�?�为空字符串，或者在转换过程中发生异常，均返回defaultValue，否则返回转换后的{@link Double}值�??
     ...
     * <br /> 3) value为{@link String}类型时，参�?�{@link #toDouble(String, Double)}�?
     ...
     * <p>转换不成功时返回defaultValue并记录info或�?�warn日志，不会抛出任何异常�??
     * <p>value等于null或�?�为空字符串，或者在转换过程中发生异常，均返回defaultValue，否则返回转换后的{@link BigDecimal}值�??
     ...
     * <br /> 3) value为{@link String}类型时，参�?�{@link #toDecimal(String, BigDecimal)}�?
    ...
    public static BigDecimal toDecimal(Object value, BigDecimal defaultValue) {
        ...
        if (Double.class.equals(clazz))
            ...
            // 如果使用new Decimal(doubleValue)，像89.7会变�?89.70000000000000012之类�?
