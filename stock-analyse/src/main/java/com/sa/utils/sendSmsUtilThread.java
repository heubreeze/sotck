 ...
 * 给多个用户发送营销类短信线程
 * @Author: xuguoyin                     
 * @Filename: huanXinRegisterThread.java
 * @Version: 1.0
 * @Date 2015年9月8日 下午4:26:28
 * @Description 
...
-99 系统未知错误
*/
public class sendSmsUtilThread implements Runnable {
    ...
    public sendSmsUtilThread(List<String> telPhones, String message) {
        this.telPhones = telPhones;
        this.message = message;
        if (telPhones == null) {
            telPhones = new ArrayList<String>();
        }
    ...
    public static void main(String[] args) {
        ...
        sendSmsUtilThread s = new sendSmsUtilThread(tels, "你好2015-12-08");
        new Thread(s).start();
    }
}
